...
class BearAgent:
    ...
    def modify_code(self, code: str, instruction: str) -> str:
        ...
        Returns:
            Modified code
        """
        prompt = f"Modify the following code according to this instruction: {instruction}\n\n```\n{code}\n```\n\nProvide only the modified code."
        return self.chat(prompt)
    ...
    def chat(self, message: str, system_prompt: Optional[str] = None) -> str:
        ...
        if system_prompt:
            ...
            messages.append({
                "role": "system", 
                "content": "You are Bear Code, an expert AI coding agent that helps with code analysis, generation, and modification. Be concise and practical."
            })
